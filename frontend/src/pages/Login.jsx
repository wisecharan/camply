...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Save authentication state to Context/LocalStorage
            login(response.data);
            
            // Open the specific dashboard in a new tab
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#4a1517] to-[#170506] flex items-center justify-center p-4 sm:p-6 lg:p-8 font-sans">
            <div className="w-full max-w-[1100px] h-[90vh] min-h-[650px] max-h-[850px] bg-white rounded-[2.5rem] p-3 flex flex-col lg:flex-row shadow-2xl">
                ...
                <div className="relative hidden lg:block w-1/2 h-full rounded-[2rem] overflow-hidden bg-gray-900">
                    <img 
                        src="https://images.unsplash.com/photo-1518277912119-d22a050f22d7?q=80&w=765&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
                        alt="VR Experience" 
                        className="absolute inset-0 w-full h-full object-cover opacity-90"
                    />
                    <div className="absolute inset-0 bg-gradient-to-tr from-red-900/70 via-orange-900/20 to-transparent mix-blend-multiply"></div>
                </div>
                ...
                <div className="w-full lg:w-1/2 h-full flex flex-col px-6 py-8 lg:px-14 overflow-y-auto no-scrollbar">
                    <div className="w-full max-w-[420px] mx-auto my-auto">
                        ...
                        <p className="text-gray-600 mb-8">
                            Don't have an account? <button onClick={() => navigate('/register')} className="text-gray-900 font-semibold hover:underline">Create an Account</button>
                        </p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-900 mb-1.5">Email Address or Username</label>
                                <input
                                    type="text" 
                                    required
                                    value={email}
                            ...
                            <div>
                                ...
                                <div className="flex justify-end mt-2.5 mb-1">
                                    <a href="#" className="text-xs sm:text-sm font-semibold text-gray-900 hover:underline">Forgot Password?</a>
                                </div>
                            </div>
